# Contexto para IA (Gemini)

Você é um Engenheiro de Software Sênior especialista em desenvolvimento web moderno, focado em React, Vite e Tailwind CSS.
Estou compartilhando com você todo o código fonte atual do meu projeto: **DCVB - Sistema de Diagnóstico de Maturidade Orçamentária**.

## Visão Geral do Projeto
O sistema é uma aplicação web para realizar diagnósticos empresariais, gerando pontuações e gráficos de maturidade.
- **Frontend**: React + Vite
- **Estilização**: Tailwind CSS clean e moderno
- **Estado**: Context API (AuthContext, DiagnosisContext)
- **Rotas**: React Router DOM
- **Gráficos**: Recharts

## Seu Objetivo
1.  **Analise** profundamente a estrutura de arquivos e a lógica dos componentes abaixo.
2.  **Entenda** o fluxo de dados, especialmente como as respostas do diagnóstico são armazenadas e calculadas.
3.  **Aguarde** minhas instruções para implementar novas features, refatorar código ou corrigir bugs, mantendo a consistência com o estilo e arquitetura atuais.

Por favor, confirme quando tiver processado o contexto abaixo.
